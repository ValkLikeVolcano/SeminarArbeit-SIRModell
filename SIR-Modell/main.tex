...
Zur Formulierung des Modells werden drei Differenzialgleichungen verwendet, welche die Änderungsrate der jeweiligen Population beschreiben, also wie schnell sich Individuen der Suszeptiblen Gruppe in die Infizierte,und von der Infizierten zu der Entfernten Population übergehen. Es gibt einige Variationen dieser Gleichungen welche beispielsweise den Kontakt von Individuen unterschiedlicher Populationen mit einbeziehen, diese Arbeit verwenden allerdings die von Kermack und McKendrick aufgestellten Versionen welche folgendermaßen aufgestellt werden:
...
\begin{center}
Änderungsrate der Entfernten Population \cite[s.10]{3}
\end{center}
