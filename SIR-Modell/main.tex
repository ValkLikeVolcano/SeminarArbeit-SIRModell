...
Die Suszeptible und die Infizierte Population haben den Parameter \textbeta \space gemeinsam. \textit{S} wird mit der rate \textbeta \space eine Menge an Individuen abgezogen (-\textbeta) und dann \textit{I} hinzugefügt. Da zur Infektion eine Begegnung mit \textit{I} benötigt wird wird \textbeta\textit{S} mit \textit{I} multipliziert. %SOURCES BIBBA
...
\subsection{Graphische Darstellung Des Modells}
